...
<div class="container">
    <div class="image-section">
        <img src="<%= request.getContextPath()%>/assets/images/register.png" alt="Student Workspace">
    </div>
    <div class="form-section">
        <div class="form-container">
            ...
            <div class="login-link">
                <p>Don't have an account? <a href="<%= request.getContextPath()%>/views/auth/register.jsp">Register here</a></p>
            </div>
        </div>
    </div>
</div>
